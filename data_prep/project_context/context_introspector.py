...
class ContextRetriever:
  ...
  def _refine_function_list_from_summary(self):
    ...
    for function in all_functions:
      ...
      self._all_functions_summary[function['Func name']].append({
          ...
          'args': function['Args'],
          'arg_names': function.get('ArgNames', []),
          'arg_tags': arg_tags,
          'raw_arg_types': raw_arg_types,
          'return_type': return_type,
          'return_tag': return_tag,
          'raw_return_type': raw_return_type,
          'raw_function_name': function.get('raw-function-name', ''),
          'source_line_begin': function.get('source_line_begin', '-1'),
          'source_line_end': function.get('source_line_end', '-1'),
          'callsites': function.get('callsites', [])
      })
  ...
  def get_function_signature(self) -> str:
    ...
    function_info_list = self._all_functions_summary.get(
        self._function_name, [])
  ...
  def get_function_type_info(self):
